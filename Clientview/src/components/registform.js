...
<div class="row">
 ...
 <div style={{ color: "red", }}>{interestErr}</div> 
     ...
     <input type ="text" name="University" value={this.state.value} onChange={this.universityhandler} id="University"placeholder="University" style={{width:'100%'}}/><br/><br/>
 ...
 <label>Looking For:</label>
    ...
    <div style={{ color: "red",  }}>{interestErr}</div> 
        ...
        <br/>
               <div class="row">
                 <div class="col-12">
              <input type ="text" name="Skills" value={this.state.skills} onChange={this.skillshandler} id="Skills"placeholder="Skill Set"className={skillsErr ? ' showError' : ''}   style={{width:'100%'}}/><br/><br/>
